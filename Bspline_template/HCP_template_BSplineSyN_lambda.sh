...
export ANTSPATH=/ifs/loni/faculty/shi/spectrum/yxia/software/ANTs/bin/
export PATH=${ANTSPATH}:$PATH

outputPath=/ifs/loni/faculty/shi/spectrum/yxia/dataset_harm/HCP5/FA_template_recent_lambda/
